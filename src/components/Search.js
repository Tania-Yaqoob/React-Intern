...
class Search extends Component {
  ...
  search() {
    let url = `https://api.themoviedb.org/3/search/movie?api_key=29d62274e14964e04e0a98c5c473c7b1&language=en-US&page=1&include_adult=false&query=${this.state.query}`;
    fetch(url, {
      method: "GET",
    })
